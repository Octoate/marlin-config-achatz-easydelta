...
#define STRING_CONFIG_H_AUTHOR "(Tim Riemann, easyDelta config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "easyDelta"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 288.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 146.0 //mm  Get this value from auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 2000, 300 }
